...
export class AnalyticsController {
  ...
  @Get('overview')
  @ApiOperation({
    summary: 'Platform overview — user growth, content stats, trend charts',
  })
  @ApiQuery({
    name: 'period',
    required: false,
  ...
  @ApiOperation({
    summary:
      'Content performance — top categories, top articles, type distribution',
  })
  @ApiQuery({
    name: 'period',
    required: false,
  ...
  @Get('top-creators')
  @ApiOperation({
    summary: 'Top creators — authors by views, contributors, top earners',
  })
  @ApiQuery({
    name: 'period',
    required: false,
  ...
  @ApiOperation({
    summary:
      'Conversion funnel — visitor to editor journey with conversion rates',
  })
  getConversionFunnel() {
  ...
  @ApiOperation({
    summary:
      'Platform summary — all entity counts in one call (for dashboard cards)',
  })
  getPlatformSummary() {
