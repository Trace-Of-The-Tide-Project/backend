...
export class ArticlesController {
  ...
  @Get()
  @ApiOperation({
    summary: 'List all articles with pagination, search, filters',
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: "Get current user's article stats (published, drafts, views)",
  })
  myStats(@Req() req: any) {
  ...
  @ApiOperation({
    summary: 'Get articles in a collection with stats (count, total hours)',
  })
  ...
  @Get(':id')
  @ApiOperation({
    summary: 'Get article by ID with blocks, contributors, tags, collection',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Returns up to 4 related published articles based on shared category and tags.',
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Create a new article (draft) with optional blocks and tags',
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Update article (author only — replaces blocks/tags if provided)',
  })
  update(
    @Param('id') id: string,
  ...
  @ApiOperation({
    summary:
      'Publish article (requires at least 1 block, recalculates reading time)',
  })
  ...
  @Post(':id/view')
  @ApiOperation({
    summary: 'Increment view count (call when article page loads)',
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Reorder blocks — send array of block IDs in desired order',
  })
