  ...
  const openCallsData = [
    {
      ...
      content_blocks: [
        {
          type: 'paragraph',
          value:
            'We invite you to share your stories and testimonies from the 1967 war. Your voice matters.',
          order: 1,
        },
        {
          type: 'image',
          value: 'https://example.com/1967-banner.jpg',
          order: 2,
        },
        {
          type: 'quote',
          value: 'History belongs to those who tell it.',
          order: 3,
        },
        {
          type: 'callout',
          value: 'Submissions accepted in Arabic, English, and French.',
          order: 4,
        },
        {
          type: 'paragraph',
          value:
            'All contributions will be archived and preserved for future generations.',
          order: 5,
        },
      ],
      main_media: {
        type: 'image',
        url: 'https://example.com/1967-cover.jpg',
        size_mb: 3,
      },
      application_form: {
        fields: [
          ...
          { name: 'phone', type: 'phone', required: true },
          {
            ...
            type: 'select',
            required: true,
            options: ['Researcher', 'Witness', 'Family Member', 'Historian'],
          },
          ...
          { name: 'city', type: 'select', required: true },
          {
            ...
            required: false,
            max_files: 5,
            allowed_types: ['jpg', 'png', 'pdf', 'mp3', 'mp4'],
            max_size_mb: 20,
          },
      ...
      seo: {
        ...
        meta_description:
          'Share your testimonies and documents from the 1967 war. Help preserve Palestinian oral history.',
      },
    ...
    },
    {
      ...
      description:
        'Celebrating stories of women preserving cultural traditions across generations.',
      category: 'cultural',
      ...
      content_blocks: [
        {
          type: 'paragraph',
          value:
            'Women have always been the backbone of cultural preservation — from embroidery to storytelling.',
          order: 1,
        },
        {
          type: 'image',
          value: 'https://example.com/women-heritage.jpg',
          order: 2,
        },
        {
          type: 'quote',
          value: 'When a grandmother tells a story, a whole world is saved.',
          order: 3,
        },
        { type: 'divider', value: '', order: 4 },
        {
          type: 'paragraph',
          value:
            'We are looking for photographers, writers, and filmmakers to document these stories.',
          order: 5,
        },
        {
          type: 'callout',
          value:
            'Selected works will be exhibited at the Palestine Museum in 2026.',
          order: 6,
        },
      ],
      main_media: {
        type: 'image',
        url: 'https://example.com/women-cover.jpg',
        size_mb: 4,
      },
      application_form: {
        fields: [
          ...
          { name: 'portfolio_link', type: 'text', required: false },
          {
            ...
            required: false,
            max_files: 10,
            allowed_types: ['jpg', 'png', 'pdf', 'mp4', 'doc'],
            max_size_mb: 20,
          },
          { name: 'terms_agreement', type: 'checkbox', required: true },
        ],
      ...
      seo: {
        ...
        meta_description:
          'Submit your work celebrating women who preserve cultural traditions across Palestine.',
      },
    ...
    },
    {
      ...
      description:
        'Building a comprehensive photographic archive of daily life in Palestine.',
      ...
      content_blocks: [
        {
          type: 'paragraph',
          value:
            'We are building the largest open-access photographic archive of Palestinian daily life.',
          order: 1,
        },
        {
          type: 'gallery',
        ...
        {
          type: 'author_note',
          value: 'This open call is still in draft and will be published soon.',
          order: 3,
        },
      ],
      main_media: {
        type: 'image',
        url: 'https://example.com/photo-archive-cover.jpg',
        size_mb: 5,
      },
      application_form: {
        fields: [
      ...
      seo: {
        title: 'Palestinian Photography Archive 2026',
        meta_description:
          'Contribute to the largest photographic archive of Palestinian daily life.',
      },
    },
  ];
  ...
  const participantsData = [
    {
      ...
      about:
        'Platform administrator contributing to oral history preservation.',
      country: 'Palestine',
      city: 'Ramallah',
      terms_agreed: true,
      form_answers: {
